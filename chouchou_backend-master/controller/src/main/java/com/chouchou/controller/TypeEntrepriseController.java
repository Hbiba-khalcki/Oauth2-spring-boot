...
@RestController
@RequestMapping("/type_entreprise")
public class TypeEntrepriseController {

		
		@Autowired
		TypeEntrepriseService _serv ;
		...
		public Optional<TypeEntreprise> findByID(@PathVariable Long id)
		{
		...
		@ResponseBody
		public String savOrUpdate(@RequestBody TypeEntreprise o)
		{
			if (o != null) {
				_serv.savOrUpdate(o);
